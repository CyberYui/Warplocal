...
fn test_stripe_api_key() {
    let stripe_api_key = "sk_live_DUMMY_KEY_FOR_TESTING_PURPOSES_12345678";
    let stripe_restricted_api_key = "rk_live_DUMMY_KEY_FOR_TESTING_PURPOSES_12345678";
    let stripe_api_test_key = "sk_test_DUMMY_KEY_FOR_TESTING_PURPOSES_12345678";
...
fn test_github_tokens() {
    let classic_personal_token = "ghp_DUMMY_TOKEN_FOR_TESTING_PURPOSES_12345678901234";
    let fine_grained_personal_access_token = "github_pat_DUMMY_TOKEN_FOR_TESTING_PURPOSES_123456789012345678901234567890123456789012345678901234";
    let gh_oauth_token = "gho_DUMMY_TOKEN_FOR_TESTING_PURPOSES_12345678901234";
...
fn test_google_api_key() {
    let google_api_key = "AIza_DUMMY_KEY_FOR_TESTING_PURPOSES_12345678901234567";
...
fn test_fireworks_api_key() {
    let fireworks_key = "fw_DUMMY_KEY_FOR_TESTING_PURPOSES_12345678901234";
...
fn test_aws_access_id() {
    let amazon_credentials = r#"{
        "Credentials": {
            "AccessKeyId": "ASIA_DUMMY_KEY_FOR_TESTING_PURPOSES_12345678",
        }
      }"#;
