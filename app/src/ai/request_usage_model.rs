...
fn cache_request_limit_info(_request_limit_info: RequestLimitInfo, _app_mut: &mut AppContext) {}
...
impl AIRequestUsageModel {
    ...
    pub fn refresh_request_usage_async(&self) {}

    pub fn update_request_limit_info(&self, _info: RequestLimitInfo) {}
