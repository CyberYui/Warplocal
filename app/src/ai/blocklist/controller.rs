...
impl BlocklistAIController {
    ...
    fn send_request_input(
        ...
        log::info!("controller: creating ResponseStream for conversation={} model={}", conversation_data.id, request_params.model);
    ...
    fn handle_response_stream_event(
        ...
        match event {
            ...
            ResponseStreamEvent::AfterStreamFinished { cancellation } => {
                ...
                AIRequestUsageModel::handle(ctx).update(ctx, |request_usage_model, _ctx| {
                    request_usage_model.refresh_request_usage_async();
                });
